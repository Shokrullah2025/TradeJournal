    ...
    return (
      <div className="card">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500 dark:text-gray-400">No drawdown data available</p>
        </div>
      </div>
    );
  }
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <span className="ml-1 font-semibold text-danger-600 dark:text-danger-400">
                ${data.drawdown.toLocaleString()} ({data.drawdownPercent.toFixed(1)}%)
              </span>
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
          <div className="text-lg font-bold text-gray-900 dark:text-gray-100">
            ${drawdownData[drawdownData.length - 1]?.runningPnL.toLocaleString() || '0'}
          </div>
