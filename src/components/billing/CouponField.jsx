...
const CouponField = ({ onApply, onClear, disabled, initialApplied = null }) => {
    ...
    return (
      ...
      >
        ...
        <button
          ...
          onClick={clear}
          disabled={disabled}
          data-test-id="coupon-remove-btn"
  ...
  return (
    <div>
      ...
      {error && (
        <p className="mt-1 text-xs text-red-600 dark:text-red-400" data-test-id="coupon-error" role="alert">
          {error}
        </p>
      )}
    </div>
