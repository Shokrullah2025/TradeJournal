  ...
  >
    <div className="px-4 sm:px-6 lg:px-8 py-4">
      ...
      <p className="mt-2 text-center text-xs text-gray-400 dark:text-gray-500">
        © {new Date().getFullYear()} [COMPANY LEGAL NAME]. All rights reserved. ZalorTrade is not a registered investment adviser and does not provide financial or trading advice.
      </p>
    </div>
  </footer>
);
