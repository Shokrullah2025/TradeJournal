          ...
          {days.map((day, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Trade indicators */}
                {hasTrades && (
                  <div className="space-y-1 position: absolute bottom-2 left-2">
                    {/* Daily P&L */}
                    <div className="text-xs font-medium">
                      {isProfit ? (
                        <span className="text-green-700 flex items-center absolute bottom-2">
                    ...
                    {/* Trade count */}
                    <div className="flex items-center justify-normal absolute bottom-2 right-2">
                      ...
                      {dayTrades.length >= 2 &&
                        (() => {
                          ...
                          const winRate =
                            (winningTrades / dayTrades.length) * 100;
