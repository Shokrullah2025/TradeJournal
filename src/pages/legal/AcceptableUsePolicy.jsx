...
const AcceptableUsePolicy = () => (
  ...
  >
    ...
    <h2>1. Scope</h2>
    <p>
      This AUP applies to all access to and use of ZalorTrade, including your account, any API integrations, broker connections, file uploads, data entries, and any automated or manual interaction with the Service.
    </p>
