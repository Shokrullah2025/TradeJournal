...
const CookiePolicy = () => (
  ...
  >
    <p>
      This Cookie Policy explains how <strong>[COMPANY LEGAL NAME]</strong> ("Company," "we," "us," or "our") uses cookies and similar browser storage technologies on Trade Journal Pro (the "Service"). It should be read alongside our <Link to="/privacy">Privacy Policy</Link>.
    </p>
    ...
    <p>Trade Journal Pro uses only <strong>strictly necessary</strong> first-party cookies. We do not use analytics, advertising, or social media tracking cookies of any kind.</p>
      ...
      <table className="w-full text-sm border-collapse">
        ...
        <tbody>
          <tr>
            ...
            <td className="px-3 py-2 border border-gray-300 dark:border-gray-600">Stores your authenticated session token, enabling you to stay logged in to Trade Journal Pro. Set by Supabase Auth. Required for the Service to function.</td>
    ...
    <p>
      In addition to cookies, Trade Journal Pro uses your browser's <code>localStorage</code> to remember certain non-sensitive preferences between sessions. localStorage data is stored entirely on your device and is not transmitted to our servers with every request. It is not a cookie.
    </p>
    ...
    <p>
      Trade Journal Pro does <strong>not</strong> embed:
    </p>
    <ul>
    ...
    <p>
      As a result, no third-party cookies are set when you use Trade Journal Pro.
    </p>
    ...
    <p>
      <strong>Please note:</strong> Blocking or deleting the authentication cookie (<code>sb-*-auth-token</code>) will prevent you from logging in to Trade Journal Pro. This is a strictly necessary cookie and the Service cannot function without it.
    </p>
    <p>
