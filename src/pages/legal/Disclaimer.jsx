  ...
  >
    <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-700 rounded-lg px-5 py-4 mb-6">
      ...
      <p className="text-amber-800 dark:text-amber-300">
        Trade Journal Pro is a trade recordkeeping and analytics tool. It does NOT provide investment advice, financial guidance, trading signals, or recommendations of any kind. All trading decisions are solely your responsibility.
      </p>
    </div>

    <h2>1. Not Investment Advice</h2>
    <p>
      Nothing contained in Trade Journal Pro, including but not limited to analytics outputs, win rate statistics, profit factor calculations, Sharpe ratio displays, drawdown charts, trade performance summaries, backtesting results, or any other data displayed by the Service, constitutes investment advice, financial advice, trading advice, legal advice, tax advice, or any other type of professional advice.
    </p>
    <p>
    ...
    <p>
      The backtesting feature in Trade Journal Pro allows you to simulate hypothetical trades on historical market data. <strong>Backtesting results are inherently hypothetical and simulated, not actual trading results.</strong> They are subject to significant limitations, including but not limited to:
    </p>
    <ul>
    ...
    <p>
      Backtesting results displayed in Trade Journal Pro are for <strong>educational and informational purposes only</strong>. They do not represent actual trading results and should not be used to make live trading decisions.
    </p>
    ...
    <p>
      Trade data imported from broker integrations (Tradovate, Alpaca, and others) is provided by those brokers' APIs "as is." We do not verify the accuracy, completeness, or timeliness of broker-provided data. Discrepancies between data in Trade Journal Pro and your official broker account statements may exist. Always rely on your official broker account statements for your definitive trading records.
    </p>

    <h2>8. User Assumes All Responsibility</h2>
    <p>
      By using Trade Journal Pro, you acknowledge and agree that:
    </p>
    <ul>
    ...
    <p>
      Trade Journal Pro operates as a software-as-a-service (SaaS) application providing recordkeeping and analytics functionality. It is <strong>not</strong> a broker-dealer, exchange, alternative trading system (ATS), or financial data vendor as defined by the SEC. No securities transactions occur on this platform.
    </p>
