...
const PrivacyPolicy = () => (
  ...
  >
    <p>
      This Privacy Policy describes how <strong>[COMPANY LEGAL NAME]</strong>, a Colorado limited liability company ("Company," "we," "us," or "our"), collects, uses, stores, and shares personal information when you use Trade Journal Pro (the "Service"). Our principal place of business is <strong>[PRINCIPAL ADDRESS]</strong>.
    </p>
    <p>
    ...
    <ul>
      ...
      <li><strong>Right to Portability:</strong> You may request your data in a portable format. Trade Journal Pro offers a data export feature in your account settings.</li>
