...
const RefundPolicy = () => (
  ...
  >
    <p>
      This Refund & Billing Policy governs all payment, subscription, and billing matters for Trade Journal Pro, operated by <strong>[COMPANY LEGAL NAME]</strong>, a Colorado limited liability company. This policy is incorporated by reference into our <Link to="/terms">Terms of Service</Link>.
    </p>
    <p>
    ...
    <ul>
      <li>Your Trade Journal Pro subscription <strong>automatically renews</strong> at the end of each billing period (monthly or annual, as selected at checkout).</li>
