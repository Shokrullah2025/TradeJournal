...
const TermsOfService = () => (
  ...
  >
    <p>
      ...
      <strong>ZalorTrade</strong> ("Company," "we," "us," or "our").
    </p>
    <p>
    ...
    <p className="font-medium">
      TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL ZalorTrade, ITS MEMBERS, MANAGERS, EMPLOYEES, AGENTS, LICENSORS, OR SERVICE PROVIDERS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO: LOSS OF PROFITS, LOSS OF DATA, LOSS OF GOODWILL, BUSINESS INTERRUPTION, TRADING LOSSES, OR ANY OTHER INTANGIBLE LOSSES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF (OR INABILITY TO USE) THE SERVICE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
    </p>
    <p className="font-medium">
    ...
    <p>
      These Terms are governed by and construed in accordance with the laws of the United States, without regard to conflict-of-law principles. For any dispute not subject to arbitration under Section 19, you and ZalorTrade submit to the exclusive jurisdiction of the competent state and federal courts located in the United States. The United Nations Convention on Contracts for the International Sale of Goods does not apply to these Terms.
    </p>
    ...
    <p>
      These Terms, together with our <Link to="/privacy">Privacy Policy</Link>, <Link to="/disclaimer">Financial & Risk Disclaimer</Link>, <Link to="/refund">Refund & Billing Policy</Link>, <Link to="/aup">Acceptable Use Policy</Link>, and <Link to="/cookies">Cookie Policy</Link>, constitute the entire agreement between you and ZalorTrade with respect to the Service and supersede all prior or contemporaneous agreements, representations, warranties, and understandings.
    </p>
