...
const TermsOfService = () => (
  ...
  >
    <p>
      Please read these Terms of Service ("Terms") carefully before using ZalorTrade (the "Service") operated by{" "}
      <strong>ZalorTrade LLC</strong>, a limited liability company organized under the laws of the State of Colorado, United States ("Company," "we," "us," or "our").
    </p>
    <p>
    ...
    <p>
      <strong>Auto-Renewal Disclosure (required under applicable automatic-renewal laws):</strong> Your subscription automatically renews at the end of each billing period (monthly or annual, as selected at checkout) at the then-current rate for your plan unless you cancel before the renewal date. By subscribing, you authorize ZalorTrade LLC and its payment processor, Stripe, Inc., to charge the payment method you provide on a recurring basis for the applicable subscription fee plus any applicable taxes.
    </p>
    <p>
    ...
    <p>
      This no-refund policy is clearly disclosed at the point of purchase and is a material term of your agreement with us. To the maximum extent permitted by applicable law, we are permitted to limit your remedies, and this limitation is reasonable given the nature of the digital Service.
    </p>
    ...
    <p className="font-medium">
      TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL ZalorTrade LLC, ITS MEMBERS, MANAGERS, EMPLOYEES, AGENTS, LICENSORS, OR SERVICE PROVIDERS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO: LOSS OF PROFITS, LOSS OF DATA, LOSS OF GOODWILL, BUSINESS INTERRUPTION, TRADING LOSSES, OR ANY OTHER INTANGIBLE LOSSES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF (OR INABILITY TO USE) THE SERVICE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
    </p>
    <p className="font-medium">
    ...
    <p>
      These Terms are governed by and construed in accordance with the laws of the State of Colorado and applicable federal law of the United States, without regard to conflict-of-law principles. For any dispute not subject to arbitration under Section 19, you and ZalorTrade LLC submit to the exclusive jurisdiction of the competent state and federal courts located in the State of Colorado. The United Nations Convention on Contracts for the International Sale of Goods does not apply to these Terms.
    </p>
    ...
    <p>
      These Terms, together with our <Link to="/privacy">Privacy Policy</Link>, <Link to="/disclaimer">Financial & Risk Disclaimer</Link>, <Link to="/refund">Refund & Billing Policy</Link>, <Link to="/aup">Acceptable Use Policy</Link>, and <Link to="/cookies">Cookie Policy</Link>, constitute the entire agreement between you and ZalorTrade LLC with respect to the Service and supersede all prior or contemporaneous agreements, representations, warranties, and understandings.
    </p>
